...
public class AuthController implements IController<Authorization> {
    ...
    public void login(Authorization authorization, HttpServletResponse response) throws IOException {
        ...
        if (accessToken != null) {
            ...
            Cookie cookie1 = new Cookie("inforUser", convertTo.get("fullname"));
            Cookie cookie2 = new Cookie("idUser", convertTo.get("_id"));
            cookie.setHttpOnly(true);
            cookie.setMaxAge(9999999);
            cookie.setPath("/");
            cookie1.setHttpOnly(true);
            cookie1.setMaxAge(9999);
            cookie1.setPath("/");
            cookie2.setHttpOnly(true);
            cookie2.setMaxAge(9999);
            cookie2.setPath("/");
