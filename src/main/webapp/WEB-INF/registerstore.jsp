            ...
            <div class="tab-pane active" role="tabpanel" id="step1">
                ...
                <div class="form-group">
                    ...
                    <div class="gallery">
                        ...
                        <div class="desc ">Chọn ảnh đại diện <input style="width: 100%;display: none;" type="file" class="btn btn-danger img-store-register"/></div>
            ...
            <div class="tab-pane" role="tabpanel" id="step2">
                ...
                <form>
                    <div class="form-group row">
                        <div class="form-control col-md-7" style="width: 60%" >
                            ...
                            <div class="desc " style="display: none;"> <input type="file" class="btn btn-danger img-giayphep"/></div>
                        </div>
                        <div class="col-md-5">
                            <h2>Chú ý:</h2>
                            <div>
                ...
                <ul class="float-right">
                   <li class="list-inline-item">
                    ...
                    <li class="list-inline-item">
                        <button type="submit" class="btn btn-danger btn-info-full next-step">Hoàn thành</button>
                    </li>
                </ul>
            </div>
