        ...
        <div class="col-10 col-sm-10 col-md-11">
            <div class="row profile-header">
                ...
                <div class="col-md-2 profile-container-buttons">
                    ...
                    <button class="btn btn-danger form-control" data-toggle="modal" data-target="#history"><i class="fas fa-history"></i>Lịch sử đơn hàng</button>
                </div>
                <!--                modal history-->
                                ...
                                <div class="history-đonhang">
                                    ...
                                    <div class="history-contain">
                                        ...
                                        <div >
                                            ...
                                            <div style="display: flex;">
                                                <div class="history-price"><span>25.000</span>VNĐ</div><span class="history-item">(2 phần)<span>
                                                        </div>
                                                            ...
                                                            <div class="col-md-4 list">
                                                                ...
                                                                <div class="profile-list rounded" >
                                                                    <div class="friend-list">
                                                                        ...
                                                                        <div class="img-contain d-flex text-center">
                                                                            <div class="img-contains">
                                                                                <image class="rounded" src ="/public/image/images new feed/fruity-tingle-ice-cream-cones-121035-1.jpg" />
                                                                                <a href="#">Nguyễn Hạ</a>
                                                                            </div>
