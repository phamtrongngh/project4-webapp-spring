    ...
    <div class="row ">
        ...
        <div class="col-10 col-sm-10 col-md-11">
            ...
            <div class="row">
                ...
                <div style="margin-top: 20px">
                    <a href="#"><img class="rounded img-order" src="public/image/Background/street-food-trailer-food-truck-cartoon-vector-19682966.jpg" alt="" />
                        <div class="rounded photo ">
                ...
                <div class="rounded status">
                    <div class="alignment">
                        <div class="media">
                            <img src="public/image/avatar/Hot-Food-Logo-991x991.jpg" alt="avatar" width="50px" class="rounded-circle avatar" />
                            <div class="media-body">
                                <div class="name"> Sandwiches man <img src="public/image/icons/check.svg" class="check" alt="" />
                                </div>
                            </div>
                            <a href="#"><i class="fa fa-ellipsis-h" aria-hidden="true"></i></a>
                        </div>
                    ...
                    <div class="image1">
                        <img src="public/image/images new feed/cooky-recipe-636656153870582498.jpg" class="rounded background" alt="" />
                    </div>
                ...
                <div class="rounded status">
                    <div class="alignment">
                        <div class="media">
                            <img src="public/image/avatar/chinese-food-logo-design_139869-105.jpg" alt="avatar" class="rounded-circle avatar" />
                            <div class="media-body">
                                <div class="name">
                                    China Food <img src="public/image/icons/check.svg" class="check" alt="" />
                                </div>
                            </div>
                            <a href="#">
                                <a href="#"><i class="fa fa-ellipsis-h" aria-hidden="true"></i></a>
                    ...
                    <div class="image1">
                        <img src="public/image/images new feed/vit-quay-bac-kinh.jpg" class="rounded background" alt="" />
                    </div>
