                                ...
                                <div class="col">
                                    ...
                                    <span>${item.product.name}<span>
                                        ...
                                        <div class="row" style="margin: 0 0 0 35px;font-weight: 100;">
                                            ...
                                            <div class="col"><span class="price-foodnumber distance-status">${order.fee}</span>VNĐ</div>
                                        </div>
                                        <div class="row" style="margin: 0 0 0 35px;color: #ff0000;">
                                            <div class="col">
                                                Phiếu giảm giá: 
                                            </div>
                                            <div class="col"><span class="price-foodnumber fee-status">-${order.discount!=null?order.discount:0}</span>VNĐ</div>
                                        </div>
